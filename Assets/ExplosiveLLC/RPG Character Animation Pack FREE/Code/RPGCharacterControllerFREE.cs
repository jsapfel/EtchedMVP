...
namespace RPGCharacterAnimsFREE
{
    public class RPGCharacterControllerFREE:MonoBehaviour
    {
        ...
        public Weapon weapon = Weapon.TWOHANDSWORD;
        ...
        private void Awake()
        {
			...
			rpgCharacterWeaponControllerFREE = null; //GetComponent<RPGCharacterWeaponControllerFREE>();
			...
			ikHandsFREE = null; //GetComponentInChildren<IKHandsFREE>();

            //Set for starting two hand sword state.
            weapon = Weapon.TWOHANDSWORD;
            animator.SetInteger("Weapon", 1);
            animator.SetInteger("WeaponSwitch", -2);
            animator.SetInteger("LeftWeapon", 1);
            animator.SetInteger("RightWeapon", -1);
        ...
        public void Attack(int attackSide)
        {
            ...
            */
            ...
            Invoke("hitEnemies", 0.5f);
        }
        private  void hitEnemies()
        {
	        Collider[] colliders = Physics.OverlapSphere(transform.position + Vector3.up + 0.75f*transform.forward,
			        1.5f, LayerMask.GetMask("Walkable"));
	        foreach (var c in colliders)
	        {
		        if (c.CompareTag("Enemy1"))
			        c.GetComponent<Enemy1Controller>().Hit();
		        else if (c.CompareTag("Enemy2"))
			        c.GetComponent<Enemy2Controller>().Hit();
	        }
        }
        ...
        public void GetHit(Vector3 dir)
        {
            ...
            StartCoroutine(rpgCharacterMovementControllerFREE._Knockback(dir, 1000, 0));
